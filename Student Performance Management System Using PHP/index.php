...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">SPMS-(Student Performance Management System)</a>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Student Performance Management System <?php echo date('Y');?></p></div>
        </footer>
        <!-- Bootstrap core JS-->
